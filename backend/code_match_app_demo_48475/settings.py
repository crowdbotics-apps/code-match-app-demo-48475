"""
Django settings for code_match_app_demo_48475 project.
...
ROOT_URLCONF = 'code_match_app_demo_48475.urls'
...
WSGI_APPLICATION = 'code_match_app_demo_48475.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Code Match App Demo Support <support@code-match-app-demo-48475.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "code_match_app_demo_48475 API",
    "DESCRIPTION": "API documentation for code_match_app_demo_48475 App",
    "VERSION": "v1",
}
